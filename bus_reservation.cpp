...
void a::reservation()
{
  ...
  while(y<=t)
  {
    ...
    if(bus_seat>32)
    {
      cout<<"\nThere are only 32 Seats Available in this Bus. Please select a new seat accordingly.";
    }
    else
    {
    if (strcmp(bus[y].bus_seat[bus_seat/4][(bus_seat%4)-1], "Empty")==0)
      {
        ...
        cout << "\nYour seat has been booked. Wishing you a pleasant journey!";
        break;
      }
    else
      cout<<"The Seat Number that you have selected is Already Reserved by another passenger. Please select another seat.\n";
      }
      }
    if(y>t)
    {
      cout<<"The bus number that you have selected, does not exist. Please enter the correct Bus Number.\n";
      goto top;
    }
  }
...
void a::avail()
{
    cout<<"Here is a list of all buses available: " <<endl;
  for(int y=0;y<t;y++)
  {
    bus_line('*');
